!function(window) {
    ...
    JTopo = {
        ...
        MouseCursor: {
            ...
            move: "move",
            open_hand: "url(../images/user.png) 8 8, default",
            closed_hand: "url(../images/user.png) 8 8, default"
        },
...
function(a) {
    function b(c) {
        ...
        this.setImage = function(b, c) {
            if (null == b)
                throw new Error("Node.setImage(): 鍙傛暟Image瀵硅薄涓虹┖!");
            var d = this;
            if ("string" == typeof b) {
                var e = j[b];
                null == e ? (e = new Image,
